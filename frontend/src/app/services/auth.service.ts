...
export class AuthService {
  ...
  getToken(): string | null      { return localStorage.getItem('ewaste_token'); }
  getRole(): string | null       { return localStorage.getItem('ewaste_role'); }
  getName(): string              { return localStorage.getItem('ewaste_name') || 'User'; }
  getEmail(): string             { return localStorage.getItem('ewaste_email') || ''; }
